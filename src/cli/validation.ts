...
export function validateRequired(value: any, name: string): ValidationError | null {
...
export function validateEnum(value: string, allowedValues: string[], name: string): ValidationError | null {
...
export function validateTimeRange(value: string): ValidationError | null {
...
export function validateGitUrl(url: string): ValidationError | null {
...
export function validateOutputFormat(format: string): ValidationError | null {
  const validFormats = ['plain', 'markdown', 'xml'];
  return validateEnum(format, validFormats, 'Output format');
}

export function validateContextType(type: string): ValidationError | null {
  const validTypes = ['function', 'file', 'character'];
  return validateEnum(type, validTypes, 'Context type');
}

export function validateContextDepth(depth: string): ValidationError | null {
...
export function throwIfError(error: ValidationError | null): void {
  if (error) {
